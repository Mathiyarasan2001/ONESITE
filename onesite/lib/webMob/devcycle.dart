...
class MobileDevCycle extends StatefulWidget {
  const MobileDevCycle({super.key});

  @override
  State<MobileDevCycle> createState() => _MobileDevCycleState();
}

class _MobileDevCycleState extends State<MobileDevCycle> {
  @override
